...
<body class="bg-secondary-subtle">
    <div class="container d-flex vh-100 align-items-center justify-content-center">
        <div class="card w-25 shadow-sm">
            <div class="card-body">
                <h5 class="card-title text-center">Retail Application</h5>
                <hr>
                <?php
                session_start();
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.mi n.js" integrity="sha384-YvpcrYf8tY31HB60NNkmXc5s9fDVZLES@AASSNDZ0xhy9GkcIds1K1eN7N6jIeHz" crossorigin="anonymous"></script>
</body>
</html>
<?php